...
//		}
		...
		this.gate.dispatch(new CreateProjectPermissionCommand(komeaRedmine, jsnow, [roleProjectManager.id]))
		this.gate.dispatch(new CreateProjectPermissionCommand(komeaSvn, jsnow, [roleProjectManager.id]))
