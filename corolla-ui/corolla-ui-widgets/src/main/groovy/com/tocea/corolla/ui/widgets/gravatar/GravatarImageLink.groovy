...
class GravatarImageLink extends WebComponent
{
	 ...
	 *            the email
	 */
	GravatarImageLink(final String _id, final String _email) {
	 ...
	 *            the email
	 */
	GravatarImageLink(final String _id, final String _email, final int _expectedSize) {
