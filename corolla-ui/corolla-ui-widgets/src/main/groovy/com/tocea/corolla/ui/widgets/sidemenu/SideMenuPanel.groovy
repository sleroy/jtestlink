 ...
 *
 */
package com.tocea.corolla.ui.widgets.sidemenu
	...
	protected void onInitialize() {
		...
		final ListView<MenuItem> menuItemsComponent = new ListView<MenuItem>("menu-side-repeater", this.menuItems) {
					...
					protected void populateItem(final ListItem<MenuItem> _arg0) {
						...
						AjaxLink bookmarkablePageLink = new AjaxLink("menu-side-item-link") {
									public void onClick(final AjaxRequestTarget target) {
										SideMenuPanel.this.setResponsePage(pageLink.getPage())
