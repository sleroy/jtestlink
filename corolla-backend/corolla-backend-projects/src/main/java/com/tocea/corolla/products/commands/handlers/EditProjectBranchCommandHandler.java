...
import com.tocea.corolla.products.events.EventProjectBranchUpdated;
...
public class EditProjectBranchCommandHandler implements ICommandHandler<EditProjectBranchCommand, ProjectBranch> {
	...
	@Override
	public ProjectBranch handle(@Valid final EditProjectBranchCommand command) {
		...
		gate.dispatchEvent(new EventProjectBranchUpdated(branch));
		return branch;
	}
