 ...
 */
@Entity()
@Table(name = "product_component_types", indexes = { @Index(unique = true, columnList = "name", name = "idx_component_type_name") })
public class ComponentType implements Serializable {
	...
	public String toString() {
		return "ComponentType [id=" + this.id + ", name=" + this.name
